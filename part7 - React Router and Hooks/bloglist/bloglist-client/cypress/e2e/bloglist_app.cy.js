describe("Bloglist app", function () {
  ...
  describe("when logged in", function () {
    ...
    it("can create a new blog entry", function () {
      ...
      cy.get("#blogUrl").type(
        "https://belliniOperaBlog.it/history-of-italian-opera",
      );
    ...
    describe("and several blog entries exist", function () {
      ...
      it("only the creator can see the delete button", function () {
        cy.contains("Evolving Trends in Brazilian Literature").should(
          "not.contain",
          "delete",
        );
      });
      ...
      it("the creator can delete the blog entries they created", function () {
        ...
        cy.get("html").should(
          "not.contain",
          "Exploring Data Science in Healthcare",
        );
      });
      ...
      it.only("blogs are ordered by number of likes", function () {
        ...
        cy.get(".blogEntry")
          .eq(0)
          .should("contain", "Exploring Data Science in Healthcare");
        cy.get(".blogEntry")
          .eq(1)
          .should("contain", "Evolving Trends in Brazilian Literature");
      });
    });
  });
});
